...
struct Gateway_V1_PromptRequest {
    ...
    var hasPromptConfigID: Bool { _promptConfigID != nil }
    /// Clears the value of `promptConfigID`. Subsequent reads from it will return its default value.
    mutating func clearPromptConfigID() { _promptConfigID = nil }

    var unknownFields = SwiftProtobuf.UnknownStorage()

    init() {}

    fileprivate var _promptConfigID: String?
}
...
struct Gateway_V1_StreamingPromptResponse {
    ...
    var hasFinishReason: Bool { _finishReason != nil }
    /// Clears the value of `finishReason`. Subsequent reads from it will return its default value.
    mutating func clearFinishReason() { _finishReason = nil }
    ...
    var hasRequestTokens: Bool { _requestTokens != nil }
    /// Clears the value of `requestTokens`. Subsequent reads from it will return its default value.
    mutating func clearRequestTokens() { _requestTokens = nil }
    ...
    var hasResponseTokens: Bool { _responseTokens != nil }
    /// Clears the value of `responseTokens`. Subsequent reads from it will return its default value.
    mutating func clearResponseTokens() { _responseTokens = nil }
    ...
    var hasStreamDuration: Bool { _streamDuration != nil }
    /// Clears the value of `streamDuration`. Subsequent reads from it will return its default value.
    mutating func clearStreamDuration() { _streamDuration = nil }

    var unknownFields = SwiftProtobuf.UnknownStorage()

    init() {}

    fileprivate var _finishReason: String?
    fileprivate var _requestTokens: UInt32?
    fileprivate var _responseTokens: UInt32?
    fileprivate var _streamDuration: UInt32?
}
